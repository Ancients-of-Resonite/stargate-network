    ...
    <div class="flex gap-4 items-center">
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem disabled v-if="user">My Account</DropdownMenuItem>
          <DropdownMenuItem as-child v-if="isAdmin">
          ...
          <DropdownMenuSub>
            <DropdownMenuSubTrigger> Glyph Appearance </DropdownMenuSubTrigger>
          ...
          <DropdownMenuItem v-if="user" variant="destructive" @click="logout"
